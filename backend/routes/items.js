...
router.post('/',checkAuth,multer({storage:storage}).single('image'), async(req,res)=>{
    ...
    const item = new Item({
        ...
        maximumcustomer:req.body.maximumcustomer,
...
router.patch('/:id',getItem, async (req,res)=>{
    ...
    if(req.body.availableDate!=null){
        res.item.availableDate = req.body.availableDate
    }
    if(req.body.maximumcustomer!=null){
        res.item.maximumcustomer = req.body.maximumcustomer
        console.alert("Found");
    }
